Shader "MX/C-EyesMouth" {
	Properties {
		[Toggle(_IF_WITH_OUT_MOUTH_ON)] _IF_WITH_OUT_MOUTH_ON("IF_with_out_mouth", Float) = 0
		[Toggle(_IF_44_MOUTH_ON)] _IF_44_mouth("IF_4x4_mouth", Float) = 0
		...
		[IntRange] _MouthTileRows ("Mouth Tile Rows", Range( 1 , 8)) = 8
		[IntRange] _MouthTileCols ("Mouth Tile Cols", Range( 1 , 8)) = 8
	...
	SubShader{
		...
		#pragma target 3.0
		#pragma shader_feature_local _IF_WITH_OUT_MOUTH_ON
		#pragma shader_feature_local _IF_44_MOUTH_ON
		struct Input
		{
			float2 uv_texcoord;
			float3 worldPos;
