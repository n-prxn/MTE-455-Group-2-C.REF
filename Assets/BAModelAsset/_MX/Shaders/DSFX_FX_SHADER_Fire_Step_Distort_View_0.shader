Shader "DSFX/FX_SHADER_Fire_Step_Distort_View_0" {
	Properties {
		...
		[Toggle] _Mask_Distortion_Use ("Mask_Distortion_Use", Float) = 1
		_Mask_Speed_X ("Mask_Speed_X", Float) = 0
		_Mask_Speed_Y ("Mask_Speed_Y", Float) = 0
		_Tex_Distort ("Tex_Distort", 2D) = "white" {}
		_Distortion_Tilling ("Distortion_Tilling", Vector) = (0,0,0,0)
