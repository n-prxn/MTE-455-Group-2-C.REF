Shader "DSFX/FX_SHADER_AlphaBlend_Add_Distort_Sp_0" {
	Properties {
		...
		_SoftParticlesN ("Soft Particles N", Range(0, 2)) = 0
		_SoftParticlesInvFN ("Soft Particles 1/(F-N)", Range(0.001, 10)) = 1
	}
